...
function Course() {
  ...
  return (
    ...
    <div className=" dark:bg-slate-900 dark:text-white items-center justify-center text-center">
          <h1 className="dark:bg-slate-900 dark:text-white text-2xl  md:text-4xl">
            We're delighted to have you{" "}
            <span className="text-pink-500"> Here!</span>
          </h1>
          <p className="mt-12">
            Hello there!!!!. This is our service page where u will find all the roadmap and services that we are offering.  
          </p>
          <Link to="/">
            <button className="mt-6 bg-pink-500 text-white px-4 py-2 rounded-md hover:bg-pink-700 duration-300">
              Back
